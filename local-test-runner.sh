...
RAMPUP_SECONDS=${RAMPUP_SECONDS:-1}
...
SERVICE_ENDPOINT_UI=${SERVICE_ENDPOINT_UI:-ahwr-public-user-ui.${ENVIRONMENT}.cdp-int.defra.cloud}
SERVICE_ENDPOINT_BO=${SERVICE_ENDPOINT_BO:-ahwr-backoffice-ui.${ENVIRONMENT}.cdp-int.defra.cloud}
...
-Jdomain_bo="$SERVICE_ENDPOINT_BO" \
-Jport="$SERVICE_PORT" \
